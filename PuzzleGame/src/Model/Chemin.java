...
public class Chemin extends LinkedList<Case>{
    ...
    /**
     * Construit le chemin d'aide prévu pour le niveau choisi
     * @param niveau
     */
                        ...
                        if (this.indexOf(i)>0) {
                            if (this.get(this.indexOf(i)-1) instanceof CaseChemin) {
                                if(i instanceof CaseChemin){
                                    ...
                                    if ((this.get(this.indexOf(i)-1) instanceof CaseChemin)) {
                                        CaseChemin CaseCheminPrecedente = (CaseChemin) this.get(this.indexOf(i)-1); // on est obligé de précaste en case-chemin !
                                        CaseCheminPrecedente.setVoisin2(this.get(this.indexOf(i)));
                                    }
                                }
                            } else{
